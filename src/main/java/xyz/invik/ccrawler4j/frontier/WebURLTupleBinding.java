...
package xyz.invik.ccrawler4j.frontier;
...
public class WebURLTupleBinding extends TupleBinding<WebURL> {
    ...
    public WebURL entryToObject(TupleInput input) {
        ...
        webURL.setLabel(input.readString());
        webURL.setRedirectionDepth(input.readInt());
        return webURL;
    }
    ...
    public void objectToEntry(WebURL url, TupleOutput output) {
        ...
        output.writeString(url.getLabel());
        output.writeInt(url.getRedirectionDepth());
    }
}