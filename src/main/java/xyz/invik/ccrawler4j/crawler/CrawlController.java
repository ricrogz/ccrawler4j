...
import xyz.invik.ccrawler4j.url.TLDList;
import xyz.invik.ccrawler4j.url.URLCanonicalizer;
import xyz.invik.ccrawler4j.url.WebURL;
import xyz.invik.ccrawler4j.util.IO;
...
public class CrawlController extends Configurable {
    ...
    public void addSeed(String pageUrl) {
        addSeed(pageUrl, null, -1);
    }

    public void addSeed(String pageUrl, String label) {
        addSeed(pageUrl, label, -1);
    }
     ...
     *
     */
    public void addSeed(String pageUrl, String label, int docId) {
